...
#include <linux/module.h>/*Add for JellyBean*/
...
#define MSM_8930_TOUCH_POWER_EN_PIN 67
...
//#define CONFIG_TOUCHSCREEN_DEBUG /*add by huawei*/
#endif
#endif
...
#define cyttsp_dbg(ts, l, f, a...) {\
	if (ts->bus_ops->tsdebug >= l) \
		dev_printk(KERN_DEBUG,ts->dev, f, ## a);\
}
#else
#define cyttsp_dbg(ts, l, f, a...)
#endif /* --CONFIG_TOUCHSCREEN_DEBUG */

#if 0 /*move from board_***.c*/
