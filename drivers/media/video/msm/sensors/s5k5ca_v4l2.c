...
static struct msm_camera_i2c_reg_conf s5k5ca_recommend_settings_2[] = {
	...
	// AE target
	{0x002A, 0x0F70},
	{0x0F12, 0x0040}, //#TVAR_ae_BrAve 091222
	// AE mode
	{0x002A, 0x0F76},
	...
	// D50
	{0x0F12, 0x01A5}, //01DC  //01C8 //#TVAR_wbt_pBaseCcms[90]
	{0x0F12, 0xFFB9}, //FF76  //FF7F //#TVAR_wbt_pBaseCcms[91]
	{0x0F12, 0xFFFA}, //FFE0  //FFE4 //#TVAR_wbt_pBaseCcms[92]
	{0x0F12, 0xFF4D}, //FF4F  //#TVAR_wbt_pBaseCcms[93]
	{0x0F12, 0x0227}, //01F5  //#TVAR_wbt_pBaseCcms[94]
	{0x0F12, 0xFF97}, //FF77  //#TVAR_wbt_pBaseCcms[95]
	{0x0F12, 0x0017}, //FFCA  //FFDF //#TVAR_wbt_pBaseCcms[96]
	{0x0F12, 0xFFEC}, //FFD5  //FFE9 //#TVAR_wbt_pBaseCcms[97]
	{0x0F12, 0x01F5}, //01EC  //01BD //#TVAR_wbt_pBaseCcms[98]
	{0x0F12, 0x0111}, //0126  //011C //#TVAR_wbt_pBaseCcms[99]
	{0x0F12, 0x00F1}, //0125  //011B //#TVAR_wbt_pBaseCcms[100]
	{0x0F12, 0xFF2C}, //FF35  //FF43 //#TVAR_wbt_pBaseCcms[101]
	{0x0F12, 0x0182}, //01BE  //#TVAR_wbt_pBaseCcms[102]
	{0x0F12, 0xFF77}, //FF44  //#TVAR_wbt_pBaseCcms[103]
	{0x0F12, 0x018A}, //013E  //#TVAR_wbt_pBaseCcms[104]
	...
	{0x0028, 0x7000},
	{0x002A, 0x0D44},
	{0x0F12, 0x0014},   //awbb_MinNumOfChromaClassifyPatches  
	...
	{0x002A, 0x07C4},
	{0x0F12, 0x000E}, //700007C4 //TVAR_afit_pBaseValS[0] // AFIT16_BRIGHTNESS
	{0x0F12, 0x0000}, //700007C6 //TVAR_afit_pBaseValS[1] // AFIT16_CONTRAST
	{0x0F12, 0x0005}, //700007C8 //TVAR_afit_pBaseValS[2] // AFIT16_SATURATION
	{0x0F12, 0xFFF1}, //700007CA //TVAR_afit_pBaseValS[3] // AFIT16_SHARP_BLUR
	...
	{0x0F12, 0x000F},	//TVAR_afit_pBaseVals[25]
	...
	{0x0F12, 0x051E},	//TVAR_afit_pBaseVals[46]
	{0x0F12, 0x030F},	//TVAR_afit_pBaseVals[47]
	...
	{0x0F12, 0x0578}, //70000838 //TVAR_afit_pBaseValS[58] //AFIT8_ccm_oscar_iSaturation[7:0],   AFIT8_RGB2YUV_iYOffset [15:8]
	...
	{0x0F12, 0x6402},	//TVAR_afit_pBaseVals[62]
	{0x0F12, 0x8264},	//TVAR_afit_pBaseVals[63]
	...
	{0x0F12, 0x2804},	//TVAR_afit_pBaseVals[70]
	{0x0F12, 0x1223},	//TVAR_afit_pBaseVals[71]
	...
	{0x0F12, 0x0528},	//TVAR_afit_pBaseVals[150]
	...
	{0x0F12, 0x0480}, //70000908 //TVAR_afit_pBaseValS[162] /AFIT8_ccm_oscar_iSaturation[7:0],   AFIT8_RGB2YUV_iYOffset [15:8]
	...
	{0x0F12, 0x5502},	//TVAR_afit_pBaseVals[166]
	{0x0F12, 0x7855},	//TVAR_afit_pBaseVals[167]
	...
	{0x0F12, 0x3204}, //70000920 //TVAR_afit_pBaseValS[174] /AFIT8_Demosaicing_iDemBlurRange[7:0],   AFIT8_Sharpening_iLowSharpPower [15:8]
	{0x0F12, 0x1232}, //70000922 //TVAR_afit_pBaseValS[175] /AFIT8_Sharpening_iHighSharpPower[7:0],	AFIT8_Sharpening_iLowShDenoise [15:8]
	...
	{0x0F12, 0x0032}, //70000968 //TVAR_afit_pBaseValS[210] /AFIT16_SATURATION
	...
	{0x0F12, 0x0828},	//TVAR_afit_pBaseVals[254]
	{0x0F12, 0x051C},	//TVAR_afit_pBaseVals[255]
	...
	{0x0F12, 0x3402}, //700009E0 //TVAR_afit_pBaseValS[270] /AFIT8_sddd8a_nClustLevel_H [7:0],   AFIT8_sddd8a_DispTH_Low [15:8]
	{0x0F12, 0x5034}, //700009E2 //TVAR_afit_pBaseValS[271] /AFIT8_sddd8a_DispTH_High [7:0],	 AFIT8_sddd8a_iDenThreshLow [15:8]
	{0x0F12, 0x2850}, //700009E4 //TVAR_afit_pBaseValS[272] /AFIT8_sddd8a_iDenThreshHigh[7:0],   AFIT8_Demosaicing_iEdgeDesat [15:8]
	...
	{0x0F12, 0x143C},	//TVAR_afit_pBaseVals[279]
	...
	{0x0F12, 0x0032}, //70000A38 //TVAR_afit_pBaseValS[314] /AFIT16_SATURATION
	...
	{0x0F12, 0x00C8},	//TVAR_afit_pBaseVals[336]
	{0x0F12, 0x0014},	//TVAR_afit_pBaseVals[337]
	...
	{0x0F12, 0x0828},	//TVAR_afit_pBaseVals[358]
	{0x0F12, 0x051C},	//TVAR_afit_pBaseVals[359]
	...
	{0x0F12, 0x2828},	//TVAR_afit_pBaseVals[375]
	{0x0F12, 0x2828},	//TVAR_afit_pBaseVals[376]
	...
	{0x0F12, 0x6E04},	//TVAR_afit_pBaseVals[382]
	{0x0F12, 0x143C},	//TVAR_afit_pBaseVals[383]
	{0x0F12, 0x4019},	//TVAR_afit_pBaseVals[384]
	...
	{0x0F12, 0x0032}, //70000B08 //TVAR_afit_pBaseValS[418] /AFIT16_SATURATION
	...
	{0x0F12, 0x00DC},	//TVAR_afit_pBaseVals[440]
	{0x0F12, 0x0023},	//TVAR_afit_pBaseVals[441]
	...
	{0x0F12, 0x0828},	//TVAR_afit_pBaseVals[462]
	{0x0F12, 0x051C},	//TVAR_afit_pBaseVals[463]
	...
	{0x0F12, 0x2602},	//TVAR_afit_pBaseVals[478]
	{0x0F12, 0x2326},	//TVAR_afit_pBaseVals[479]
	{0x0F12, 0x2823},	//TVAR_afit_pBaseVals[480]
	...
	{0x0F12, 0x7804},	//TVAR_afit_pBaseVals[486]
	{0x0F12, 0x1E41},	//TVAR_afit_pBaseVals[487]
	{0x0F12, 0x401E},	//TVAR_afit_pBaseVals[488]
	...
	{0x002A, 0x01F6},
	{0x0F12, 0x2ee0},  // 1F40}, //REG_TC_IPRM_OpClk4KHz_0                   	2   700001F6
	{0x0F12, 0x32A8}, //3
	{0x0F12, 0x32E8},
...
static struct msm_camera_i2c_reg_conf s5k5ca_recommend_settings_3[] = {
	...
	{0x0F12, 0x39a4},//157C //3AA8 //#REG_0TC_PCFG_usMaxOut4KHzRate  0272
	{0x0F12, 0x37a4},//157C //3A88 //#REG_0TC_PCFG_usMinOut4KHzRate  0274
	...
	{0x0F12, 0x0001}, //2  
	{0x0F12, 0x014e},//E8 //#REG_0TC_PCFG_usMaxFrTimeMsecMult10 //10fps
	{0x0F12, 0x014e},//#REG_0TC_PCFG_usMinFrTimeMsecMult10 //22fps
	...
	{0x0F12, 0x39a4}, //157C //3AA8 //#REG_0TC_CCFG_usMaxOut4KHzRate
	{0x0F12, 0x37a4}, //157C //3A88 //#REG_0TC_CCFG_usMinOut4KHzRate
	...
	{0x0F12, 0x0002}, //#REG_0TC_CCFG_uClockInd
...
static struct msm_camera_i2c_reg_conf s5k5ca_init_reg_settings_patch[] =
{
    // Update Changed Registers
    {0x0028, 0x7000}, 
    {0x002A, 0x0664},
...
static struct msm_camera_i2c_reg_conf s5k5ca_wb_auto_reg_config[] =
{
	{0x0028, 0x7000},
	{0x002A, 0x04D2},
	{0x0F12, 0x067F}, // #REG_TC_DBG_AutoAlgEnBits
};
static struct msm_camera_i2c_reg_conf s5k5ca_wb_incandescent_reg_config[] =
{
	{0x002A, 0x04D2},
...
static struct msm_camera_i2c_reg_conf s5k5ca_wb_fluorescent_reg_config[] =
{
	{0x002A, 0x04D2},
	{0x0F12, 0x0677}, // #REG_TC_DBG_AutoAlgEnBits
	{0x002A, 0x04A0},
	{0x0F12, 0x04b8}, // #REG_SF_USER_Rgain
	{0x0F12, 0x0001}, // #REG_SF_USER_RgainChanged
	{0x002A, 0x04A4},
	{0x0F12, 0x0400}, // #REG_SF_USER_Ggain
	{0x0F12, 0x0001}, // #REG_SF_USER_GgainChanged
	{0x002A, 0x04A8},
	{0x0F12, 0x072C}, // #REG_SF_USER_Bgain
	{0x0F12, 0x0001}, // #REG_SF_USER_BgainChanged
};
static struct msm_camera_i2c_reg_conf s5k5ca_wb_daylight_reg_config[] =
{
	{0x002A, 0x04D2},
	{0x0F12, 0x0677}, // #REG_TC_DBG_AutoAlgEnBits
	{0x002A, 0x04A0},
...
static struct msm_camera_i2c_reg_conf s5k5ca_wb_cloudy_reg_config[] =
{
	{0x002A, 0x04D2},
	{0x0F12, 0x0677}, // #REG_TC_DBG_AutoAlgEnBits
	{0x002A, 0x04A0},
...
static struct msm_camera_i2c_reg_conf s5k5ca_effect_off_reg_config[] =
{
	{0x0028, 0x7000},
	{0x002A, 0x021E},
...
static struct msm_camera_i2c_reg_conf s5k5ca_effect_mono_reg_config[] =
{
	{0x0028, 0x7000},
	{0x002A, 0x021E},
...
static struct msm_camera_i2c_reg_conf s5k5ca_effect_negative_reg_config[] =
{
	{0x0028, 0x7000},
	{0x002A, 0x021E},
...
static struct msm_camera_i2c_reg_conf s5k5ca_effect_sepia_reg_config[] =
{
	{0x0028, 0x7000},
	{0x002A, 0x021E},
...
static struct msm_camera_i2c_reg_conf s5k5ca_effect_aqua_reg_config[] =
{
	{0x0028, 0x7000},
	{0x002A, 0x021E},
...
static struct msm_camera_i2c_conf_array s5k5ca_init_conf[] = {
	{&s5k5ca_recommend_settings_1[0],
		ARRAY_SIZE(s5k5ca_recommend_settings_1), 100, MSM_CAMERA_I2C_WORD_DATA},
	{&s5k5ca_recommend_settings_2[0],
		ARRAY_SIZE(s5k5ca_recommend_settings_2), 10, MSM_CAMERA_I2C_WORD_DATA},
	{&s5k5ca_recommend_settings_3[0],
		ARRAY_SIZE(s5k5ca_recommend_settings_3), 0, MSM_CAMERA_I2C_WORD_DATA},
};
static struct msm_camera_i2c_conf_array s5k5ca_path_conf[] = {
	{&s5k5ca_init_reg_settings_patch[0],
		ARRAY_SIZE(s5k5ca_init_reg_settings_patch), 0, MSM_CAMERA_I2C_WORD_DATA},
...
static struct msm_camera_i2c_conf_array s5k5ca_confs[] = {
	...
	ARRAY_SIZE(s5k5ca_prev_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
};
...
int32_t s5k5ca_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	uint16_t chipid = 0;
	if(!s_ctrl->sensordata->standby_is_supported ||  !s_ctrl->sensordata->standby_mode){

    	rc = msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x0010, 0x0001, MSM_CAMERA_I2C_WORD_DATA);
    	rc = msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x0010, 0x0000, MSM_CAMERA_I2C_WORD_DATA);
...
int32_t s5k5ca_sensor_set_wb(struct msm_sensor_ctrl_t *s_ctrl, int wb)
{
	struct msm_camera_i2c_reg_conf *reg_conf_tbl = NULL;
	uint16_t num_of_items_in_table = 0;
	int rc = 0;
	if(CAMERA_EFFECT_OFF != effect_current)
	{
		return rc;
	}
	...
	{
		case CAMERA_WB_AUTO:
			reg_conf_tbl = &s5k5ca_wb_auto_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_wb_auto_reg_config);
			break;
		case CAMERA_WB_INCANDESCENT:
			reg_conf_tbl = &s5k5ca_wb_incandescent_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_wb_incandescent_reg_config);
			break;
		case CAMERA_WB_FLUORESCENT:
			reg_conf_tbl = &s5k5ca_wb_fluorescent_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_wb_fluorescent_reg_config);
			break;
		case CAMERA_WB_DAYLIGHT:
			reg_conf_tbl = &s5k5ca_wb_daylight_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_wb_daylight_reg_config);
			break;
		case CAMERA_WB_CLOUDY_DAYLIGHT:
			reg_conf_tbl = &s5k5ca_wb_cloudy_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_wb_cloudy_reg_config);
			break;
		default:
			return 0;
	}
...
int32_t s5k5ca_sensor_set_effect(struct msm_sensor_ctrl_t *s_ctrl, int effect)
{
	struct msm_camera_i2c_reg_conf *reg_conf_tbl = NULL;
	uint16_t num_of_items_in_table = 0;
	int rc = 0;
	...
	CDBG("s5k5ca_sensor_set_effect effect= %d,  current = %d \n", effect, effect_current);
	...
	switch (effect)
	{
		case CAMERA_EFFECT_OFF:
			reg_conf_tbl = &s5k5ca_effect_off_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_effect_off_reg_config);
			break;
		case CAMERA_EFFECT_MONO:
			reg_conf_tbl = &s5k5ca_effect_mono_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_effect_mono_reg_config);
			break;
		case CAMERA_EFFECT_NEGATIVE:
			reg_conf_tbl = &s5k5ca_effect_negative_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_effect_negative_reg_config);
			break;
		case CAMERA_EFFECT_SEPIA:
			reg_conf_tbl = &s5k5ca_effect_sepia_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_effect_sepia_reg_config);
			break;
		case CAMERA_EFFECT_AQUA:
			reg_conf_tbl = &s5k5ca_effect_aqua_reg_config[0];
			num_of_items_in_table = ARRAY_SIZE(s5k5ca_effect_aqua_reg_config);
			break;
		default:
			return 0;
	}
	...
	{
		s5k5ca_sensor_set_wb(&s5k5ca_s_ctrl, wb_current);
	}
	effect_current = effect ;
	return rc;
}
int32_t s5k5ca_i2c_write_w_table(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc;
	rc = msm_sensor_write_all_conf_array(
		s_ctrl->sensor_i2c_client,
		&s5k5ca_path_conf[0],
		ARRAY_SIZE(s5k5ca_path_conf));
	if(rc < 0)
       {
                printk("%s:%d write regs fail\n",__func__,__LINE__);
        }
	msleep(100);
	return rc;
}
			...
			int update_type, int res)
{
	...
	if (update_type == MSM_SENSOR_REG_INIT) {
		...
		s5k5ca_i2c_write_w_table(s_ctrl);
...
static int s5k5ca_sensor_post_init(void *data)
{
	struct msm_sensor_ctrl_t *s_ctrl=&s5k5ca_s_ctrl;
...
static struct msm_sensor_fn_t s5k5ca_func_tbl = {
	...
	.sensor_set_effect = s5k5ca_sensor_set_effect,
	.sensor_get_csi_params = msm_sensor_get_csi_params,
	.sensor_setting = s5k5ca_sensor_setting,
	.sensor_post_init_func = s5k5ca_sensor_post_init,
};
...
static struct msm_sensor_ctrl_t s5k5ca_s_ctrl = {
	...
	//.csi_params = &s5k5ca_csi_params_array[0],
