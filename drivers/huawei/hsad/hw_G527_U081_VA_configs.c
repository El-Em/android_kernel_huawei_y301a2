...
config_pair  hw_G527_U081_VA_configs [] = {
    {"audio/aud_param_ver", (const unsigned int)(unsigned int*)"G527U081_VA_audio_A01", E_CONFIG_DATA_TYPE_STRING }, 
    {"audio/board_id", (const unsigned int)(unsigned int*)"G527U081_VA", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"battery/R_200", (const unsigned int)(unsigned int*)"HB505076RBC_SWD", E_CONFIG_DATA_TYPE_STRING }, 
    {"battery/R_470", (const unsigned int)(unsigned int*)"HB505076RBC_FMT", E_CONFIG_DATA_TYPE_STRING }, 
    {"bt/device_type", (unsigned int)BT_FM_QUALCOMM_WCN3660, E_CONFIG_DATA_TYPE_ENUM }, 
    {"bt/product_id", (const unsigned int)(unsigned int*)"G527_U081", E_CONFIG_DATA_TYPE_STRING }, 
    {"camera/board_name", (const unsigned int)(unsigned int*)"G527_U081", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"customkey/QCHAT_KEY", (unsigned int)6, E_CONFIG_DATA_TYPE_INT }, 
    ...
    {"pmicgpio/6", (unsigned int)PMIC_GPIO_INPUT, E_CONFIG_DATA_TYPE_ENUM }, 
    {"product/name", (const unsigned int)(unsigned int*)"G527_U081", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"tp/fw_file", (const unsigned int)(unsigned int*)"G527_U081_cyttsp3_fw", E_CONFIG_DATA_TYPE_STRING }, 
    {"tp/product_family", (const unsigned int)(unsigned int*)"G527_U081", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"wifi/pubfile_id", (const unsigned int)(unsigned int*)"MSM8930_G527_U081", E_CONFIG_DATA_TYPE_STRING }, 
    {0, 0, 0}
 };
struct board_id_general_struct config_common_G527_U081_VA= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_G527_U081_VA,
	.data_array={.config_pair_ptr=hw_G527_U081_VA_configs},
	.list={NULL,NULL},
};
