...
config_pair  hw_G526_L11_VA_configs [] = {
    {"audio/aud_param_ver", (const unsigned int)(unsigned int*)"G526L11_VA_audio_C01", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"bt/bt_fm_fw_ver", (const unsigned int)(unsigned int*)"120177", E_CONFIG_DATA_TYPE_STRING }, 
    {"bt/device_type", (unsigned int)BT_FM_QUALCOMM_WCN3660, E_CONFIG_DATA_TYPE_ENUM }, 
    {"bt/product_id", (const unsigned int)(unsigned int*)"G526_L11", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"nfc/nfc_chip_type", (unsigned int)BCM, E_CONFIG_DATA_TYPE_ENUM }, 
    {"nfc/nfc_support", (unsigned int)SUPPORT, E_CONFIG_DATA_TYPE_ENUM }, 
    {"product/name", (const unsigned int)(unsigned int*)"G526_L11", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"tp/product_family", (const unsigned int)(unsigned int*)"G526L", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"wifi/wlan_fw_ver", (const unsigned int)(unsigned int*)"120177", E_CONFIG_DATA_TYPE_STRING }, 
    {0, 0, 0}
 };
struct board_id_general_struct config_common_G526_L11_VA= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_G526_L11_VA,
	.data_array={.config_pair_ptr=hw_G526_L11_VA_configs},
	.list={NULL,NULL},
};
