...
config_pair  hw_M932_VB_configs [] = {
    {"audio/board_id", (const unsigned int)(unsigned int*)"M932_VB", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"bt/product_id", (const unsigned int)(unsigned int*)"M932_VB", E_CONFIG_DATA_TYPE_STRING }, 
...
struct board_id_general_struct config_common_M932_VB= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_M932_VB,
	.data_array={.config_pair_ptr=hw_M932_VB_configs},
	.list={NULL,NULL},
};
