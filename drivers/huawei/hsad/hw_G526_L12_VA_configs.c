...
config_pair  hw_G526_L12_VA_configs [] = {
    {"audio/aud_param_ver", (const unsigned int)(unsigned int*)"G526L22_VA_audio_C01", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"bt/product_id", (const unsigned int)(unsigned int*)"G526_L12", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"product/name", (const unsigned int)(unsigned int*)"G526_L22", E_CONFIG_DATA_TYPE_STRING }, 
...
struct board_id_general_struct config_common_G526_L12_VA= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_G526_L12_VA,
	.data_array={.config_pair_ptr=hw_G526_L12_VA_configs},
	.list={NULL,NULL},
};
