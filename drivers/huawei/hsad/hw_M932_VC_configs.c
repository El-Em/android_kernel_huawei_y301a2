...
config_pair  hw_M932_VC_configs [] = {
    {"audio/board_id", (const unsigned int)(unsigned int*)"M932_VC", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"battery/MPP5LMT", (unsigned int)1, E_CONFIG_DATA_TYPE_BOOL }, 
    ...
    {"bt/product_id", (const unsigned int)(unsigned int*)"M932_VC", E_CONFIG_DATA_TYPE_STRING }, 
...
struct board_id_general_struct config_common_M932_VC= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_M932_VC,
	.data_array={.config_pair_ptr=hw_M932_VC_configs},
	.list={NULL,NULL},
};
