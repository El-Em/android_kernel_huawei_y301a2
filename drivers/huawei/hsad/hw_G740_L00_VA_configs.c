...
config_pair  hw_G740_L00_VA_configs [] = {
    {"audio/aud_param_ver", (const unsigned int)(unsigned int*)"G740L00_VA_audio_A01", E_CONFIG_DATA_TYPE_STRING }, 
    {"audio/board_id", (const unsigned int)(unsigned int*)"G740L00_VA", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"bt/product_id", (const unsigned int)(unsigned int*)"G740_L00", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"lcd/id0", (const unsigned int)(unsigned int*)"mipi_otm1282a_chimei_hd", E_CONFIG_DATA_TYPE_STRING }, 
    {"lcd/id5", (const unsigned int)(unsigned int*)"mipi_otm1282a_auo_hd", E_CONFIG_DATA_TYPE_STRING }, 
    {"lcd/resolution", (unsigned int)LCD_IS_HD, E_CONFIG_DATA_TYPE_ENUM }, 
    {"nfc/nfc_chip_type", (unsigned int)BCM, E_CONFIG_DATA_TYPE_ENUM }, 
    {"nfc/nfc_support", (unsigned int)SUPPORT, E_CONFIG_DATA_TYPE_ENUM }, 
    {"product/name", (const unsigned int)(unsigned int*)"G740_L00", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"tp/product_family", (const unsigned int)(unsigned int*)"G740_L00", E_CONFIG_DATA_TYPE_STRING }, 
    {"tp/resolution", (const unsigned int)(unsigned int*)"HD", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"wifi/pubfile_id", (const unsigned int)(unsigned int*)"MSM8930_G740_L00", E_CONFIG_DATA_TYPE_STRING }, 
    {0, 0, 0}
 };
struct board_id_general_struct config_common_G740_L00_VA= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_G740_L00_VA,
	.data_array={.config_pair_ptr=hw_G740_L00_VA_configs},
	.list={NULL,NULL},
};
