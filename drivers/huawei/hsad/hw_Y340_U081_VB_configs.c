...
config_pair  hw_Y340_U081_VB_configs [] = {
    {"audio/aud_param_ver", (const unsigned int)(unsigned int*)"Y340U081_audio_C01", E_CONFIG_DATA_TYPE_STRING }, 
    {"audio/board_id", (const unsigned int)(unsigned int*)"Y340U081_VB", E_CONFIG_DATA_TYPE_STRING }, 
...
struct board_id_general_struct config_common_Y340_U081_VB= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_Y340_U081_VB,
	.data_array={.config_pair_ptr=hw_Y340_U081_VB_configs},
	.list={NULL,NULL},
};
