...
config_pair  hw_Y301_A2_VA_configs [] = {
    {"audio/aud_param_ver", (const unsigned int)(unsigned int*)"Y301_A2_audio_B04", E_CONFIG_DATA_TYPE_STRING }, 
    {"audio/board_id", (const unsigned int)(unsigned int*)"Y301A2_VA", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"battery/cutoff_v_mv", (unsigned int)3380, E_CONFIG_DATA_TYPE_INT }, 
    {"bt/device_type", (unsigned int)BT_FM_BROADCOM_BCM4330, E_CONFIG_DATA_TYPE_ENUM }, 
    {"bt/product_id", (const unsigned int)(unsigned int*)"Y301_A2", E_CONFIG_DATA_TYPE_STRING }, 
    {"camera/board_name", (const unsigned int)(unsigned int*)"y301_a2", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"fm/fm_rssi", (unsigned int)FM_RSSI_100, E_CONFIG_DATA_TYPE_ENUM }, 
    ...
    {"lcd/id5", (const unsigned int)(unsigned int*)"mipi_nt35510_boe6_wvga", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"lcd/id_5_wled_max_current", (unsigned int)23, E_CONFIG_DATA_TYPE_INT }, 
    {"lcd/resolution", (unsigned int)LCD_IS_WVGA, E_CONFIG_DATA_TYPE_ENUM }, 
    {"product/name", (const unsigned int)(unsigned int*)"Y301_A2", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"sensors/sunlight", (unsigned int)15000, E_CONFIG_DATA_TYPE_INT }, 
    {"tp/product_family", (const unsigned int)(unsigned int*)"Y301", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"wifi/device_type", (unsigned int)WIFI_BROADCOM_4330, E_CONFIG_DATA_TYPE_ENUM }, 
    {"wifi/pubfile_id", (const unsigned int)(unsigned int*)"MSM8930_Y301_A2_VA", E_CONFIG_DATA_TYPE_STRING }, 
    {0, 0, 0}
 };
struct board_id_general_struct config_common_Y301_A2_VA= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_Y301_A2_VA,
	.data_array={.config_pair_ptr=hw_Y301_A2_VA_configs},
	.list={NULL,NULL},
};
