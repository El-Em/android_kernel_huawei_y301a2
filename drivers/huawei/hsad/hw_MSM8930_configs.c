...
config_pair  hw_MSM8930_configs [] = {
    {"audio/board_id", (const unsigned int)(unsigned int*)"MSM8930", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"lcd/idB", (const unsigned int)(unsigned int*)"mipi_r63308_toshiba_720p", E_CONFIG_DATA_TYPE_STRING }, 
    {"lcd/idC", (const unsigned int)(unsigned int*)"mipi_nt35516_tianma_qhd", E_CONFIG_DATA_TYPE_STRING }, 
    {"lcd/resolution", (unsigned int)LCD_IS_FHD, E_CONFIG_DATA_TYPE_ENUM }, 
    {"product/name", (const unsigned int)(unsigned int*)"MSM930", E_CONFIG_DATA_TYPE_STRING }, 
    ...
    {"wifi/pubfile_id", (const unsigned int)(unsigned int*)"MSM8930_MSM8930", E_CONFIG_DATA_TYPE_STRING }, 
    {0, 0, 0}
 };
struct board_id_general_struct config_common_MSM8930= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_MSM8930,
	.data_array={.config_pair_ptr=hw_MSM8930_configs},
	.list={NULL,NULL},
};
