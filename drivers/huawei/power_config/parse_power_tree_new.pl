...
# Copyright (c) 2008 - 2012 by Huawei Incorporated.  All Rights Reserved.
#
#==========================================================================
...
sub generic_rpm_power_config()
{
	...
	while(1)
	{
		...
		$fore_mode = $oSheet->{Cells}[$index][15]->Value;
		$sleep_set_force_mode = $oSheet->{Cells}[$index][16]->Value;
		$tmp_index = $index + 1;
		...
		for($i=0;$i<$count;$i++)
		{
			$supply_name = $oSheet->{Cells}[$index+$i][17]->Value;
			$dev_name = $oSheet->{Cells}[$index+$i][18]->Value;
	  ...
	  print $power_config_file_handle "	      .min_uV =",$min_uv,", \\\n";
		...
		print $power_config_file_handle "  .id = RPM_VREG_ID_PM8038","_","\U$power_id",", \\\n";
		...
		if($power_type eq "SMPS"){
			...
			print $power_config_file_handle "  .power_mode = RPM_VREG_POWER_MODE_8930_PWM, \\\n";
		}
		elsif($power_type eq "CORNER"){
		...
		print $power_config_file_handle "  .pin_fn = RPM_VREG_PIN_FN_8930_NONE, \\\n";
		print $power_config_file_handle "  .force_mode = RPM_VREG_FORCE_MODE_8930","_","\U$fore_mode",", \\\n";
		print $power_config_file_handle "  .sleep_set_force_mode = RPM_VREG_FORCE_MODE_8930","_", "\U$sleep_set_force_mode",",\\\n";
...
sub generic_pmic_power_config()
{
	...
	while(1)
	{
	  ...
	  ++$nPowerCount;
	  print $power_config_file_handle "#define ","\U$product_name","_","PM8038_REG_PDATA","_","\U$nPowerCount"," \\\n";
	  print $power_config_file_handle "{ \\\n";
	  print $power_config_file_handle "  .init_data = { \\\n";
	  print $power_config_file_handle "     .constraints = { \\\n";
	  print $power_config_file_handle "	      .min_uV =",$min_uv,", \\\n";
		...
		print $power_config_file_handle "	      .apply_uV = 0, \\\n";
		print $power_config_file_handle "	      .always_on =",$always_on,", \\\n";
#20120112	modify begin for baseline 1024
		if($power_id eq "l16"){
			print $power_config_file_handle "	      .name = \"8038_l16\", \\\n";
	  }elsif($power_id eq "l19"){
	  	print $power_config_file_handle "	      .name = \"8038_l19\", \\\n";
	  }elsif($power_id eq "l27"){
	  	print $power_config_file_handle "	      .name = \"8038_l27\", \\\n";
	  }else{
	  	print $power_config_file_handle "	      .name = NULL, \\\n";
	  }
#20120122 modify end for baseline 1024
		...
		print $power_config_file_handle "  }, \\\n";
#20120112	modify begin for line 1024
		#print $power_config_file_handle "  .id = PM8038_VREG_ID","_","\U$power_id",", \\\n";
		if($power_id eq "l19"){
...
#20120122 modify end for line 1024
		print $power_config_file_handle "  .pull_down_enable = 1",", \\\n";
		print $power_config_file_handle "  .system_uA = ",$system_ua,", \\\n";
	...
	print $power_config_file_handle "\n\n\n";
#20120116 l00186656 modify the word PM8921 to PM8xxx,begin
	print $power_config_file_handle "struct pm8xxx_regulator_platform_data ","\U$product_name","_","pm8038_regulator_pdata[]  = {\n";
#20120116 l00186656 modify the word PM8921 to PM8xxx,end
	for($i=1;$i<=$nPowerCount;$i++)
	{
		print $power_config_file_handle "\U$product_name","_","PM8038_REG_PDATA","_",$i,",\n";
	}	
	print $power_config_file_handle "};\n";
...
sub generic_ext_power_config()
{
	...
	while(1)
	{
	  ...
	  print $power_config_file_handle "     .constraints = { \\\n";
		...
		print $power_config_file_handle "     .num_consumer_supplies = ARRAY_SIZE(","\U$product_name","_",$customer,"_","\U$power_id","_supply), \\\n";
		print $power_config_file_handle "     .consumer_supplies = ","\U$product_name","_",$customer,"_","\U$power_id","_supply, \\\n";
#20120112 add begin for line 1024
    if($power_id eq "ext_otg_sw"){
	     print $power_config_file_handle "     .supply_regulator = \"ext_5v\", \\\n";
	  }else{
	     print $power_config_file_handle "     .supply_regulator = NULL, \\\n";
	  }
#20120112 add end for line 1024
		print $power_config_file_handle "  }, \\\n";
	...
	print $power_config_file_handle "\n\n\n/*The static struct group msm_saw_regulator_pdata will be useful for Board-msm8930.c*/\n";
...
sub genarate_final_power_struct()
{
	 ...
	 print $power_config_file_handle "   .pmic_power_pdata = ","\U$product_name","_","pm8038_regulator_pdata",",\n";
